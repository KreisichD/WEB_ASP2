<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AboutUs.aspx.cs" Inherits="AboutUs" MasterPageFile="~/Site.master"%>
...
<asp:Content ID="aboutMainContent" ContentPlaceHolderID="MainContent" runat="server">
    <article id="toChange">
            ...
            <h2>Lorem ipsum <sup>20</sup><sub>18</sub></h2>

            <h2 id="r1" class="pink">Lorem</h2>
            <p id="p1">
